		...
		return (
			<>
				<div className={styles.listItemContainer}>
					<Link href="https://www.instagram.com/beserikantini/" passHref>
						<a target="_blank">
							<div className={styles.listItem}>
								<div className={styles.listItemName}>
									<Image
										src="/icons/podcasts/beseri-kantini.jpg"
										alt="icon"
										width={16}
										quality={100}
										height={16}
					...
					<Link href="https://www.fidirokahvesi.com/" passHref>
						<a target="_blank">
							<div className={styles.listItem}>
								<div className={styles.listItemName}>
									<Image
										src="/icons/podcasts/fidiro.jpeg"
										alt="icon"
										width={16}
										quality={100}
										height={16}
					...
					<Link href="www.kodsalbakis.com" passHref>
						<a target="_blank">
							<div className={styles.listItem}>
								<div className={styles.listItemName}>
									<Image
										src="/icons/podcasts/kodsal.jpeg"
										alt="icon"
										width={16}
										quality={100}
										height={16}
